...
class Q1
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("\nDeveloped by: Jatin Dixit (MCA 2nd Year - Sec C)\nRoll No: 2484200083");
    }
}
...
class Q8
{
    ...
    static void ApplyDiscount(double amount)
    {
        ...
        Console.WriteLine($"Price after 20% discount: ₹{discountedPrice}");
    }
...
class Q10
{
    ...
    static void SendSMS(string message)
    {
        ...
        Console.WriteLine("SMS sent to: 2482339568");
        Console.WriteLine("------------------------");
    }
